...
import iqlogo from "./iqcampaign700final.png"
...
const Campaign = () => {
            ...
            <div className={styles.modal}>
                <div className="d-flex container-fluid" id=" visual-comprobante" style={{ justifyContent: "start", alignItems: "center", backgroundColor: "#efeeee" }}>
                    <div style={{ padding: "10px" }}>
                        <h3 style={{ fontSize: "1.2rem" }}>Create Appointment </h3>
                    </div>
                    <br />
                </div>
                        ...
                        <div className="row d-flex">
                            ...
                            {/* <div className="col-2 justify-content-center align-items-center">
                                <button className="btn btn-outline-success" type="button"
                                    onClick={() => { setAssistant(!assitant) }}>Assistant</button>
                            </div> */}
                            {/* {assitant ? <>
                                <br />
                                <div className="row d-flex">
    ...
    useEffect(() => {
        const dataFetch = async () => {
            let calendarFetch = await actions.useFetch(urlCheck, {
                Compania: store.user.JRCompaniaAut[0],
            }, "POST");
            if (calendarFetch.ok) {
    ...
    return (
        <div className={`container-fluid ${styles2.campaigns_container}`}>
            <div className="row d-flex justify-content-center align-items-center">
                {/* <h2 className="d-flex justify-content-center align-items-center">QLX Campaigns</h2> */}
                <img className={`${styles2.img_logo}`} src={iqlogo} width={`300px`}/>
            </div>

            <br />
            <br />
            <div className="row d-flex">
                <div className="col-2"><SideMenu reload={reload} setReload={setReload} /></div>
            ...
            <div className="row d-flex">
                <div className="col-12"><CampaignList reload={reload} setReload={setReload} /></div>
