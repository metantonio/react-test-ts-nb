...
import IAInput from "../../components/IA/iaInterface.jsx";
...
const CampaignCalendar = ({ campaignD }) => {
    const urlUpdate = "/campaign/updateCalendar";
        ...
        async ({ start, end, id, messages, titleMain, emails, reminder }) => {
            ...
            if (titleMain) {
                let obj = {
                    ...
                    Calendar: [...newEvent, { start, end, title: titleMain, id, messages, emails, reminder, sent: false, campaign_id: campaignD.id }]
                }
