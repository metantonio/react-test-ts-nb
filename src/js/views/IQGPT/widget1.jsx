...
const WidgetTech1 = () => {
    ...
    return (
        <div className={styles.window1}>
            <button className={styles.button_approve} type="button" data-bs-toggle="offcanvas" data-bs-target="#widget1" aria-controls="widget1" style={{marginBottom:"50px"}}>Latest prompts</button>
            <button className={styles.button_approve} type="button" data-bs-toggle="offcanvas" data-bs-target="#widgetCluster" aria-controls="widgetCluster">Cluster prompts</button>
