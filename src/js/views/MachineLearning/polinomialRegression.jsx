...
const PolinomialRegression = () => {
    ...
    const urlML = "/upload-csv-polinomial-regression"
                ...
                <div className='container-fluid'>
                    <form onSubmit={(e) => handleSubmitCSV(e)}>
                        <div className='row d-flex'>
                            <div className='col'>
                                <div className="step-label">Polinomial Regression</div>
                            </div>
                            <div className='row d-flex'>
...
export default PolinomialRegression