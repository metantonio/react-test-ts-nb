...
const SimpleLinear = () => {
    ...
    const urlML = '/upload-csv-simple-linear-regression'
    const urlMLDB = '/upload-csv-simple-linear-regression-db'
                ...
                <div className='container-fluid'>
                    <form onSubmit={(e) => handleSubmitCSV(e)}>
                        <div className='row d-flex'>
                            <div className='col'>
                                <div className="step-label">Simple Linear Regression</div>
                            </div>
                            <div className='row d-flex'>
                            ...
                            {srcDB.code === "csv" ? <> <div className='col'>
                                ...
                                srcDB.code === "db" ?
                                    <div className='col'>
                                        <div className="row d-flex justify-content-between" role="group" aria-label="Basic checkbox toggle button group">
                                            <div className='col'>
                                                <label className='text-dark'>Select a Campaign</label>
                                                <label className='text-dark'>Here will go campaign dropdown</label>
                                            </div>
                                        </div>
                                    </div>
                                    :
                    ...
                    <div className='row d-flex flex-row'>
                        <div className='col text-dark'>
                            {xgBoostData.acurracy ? <> Acurracy:  {xgBoostData.acurracy.toFixed(3)} %</> : <></>}
                        </div>
                        <div className='col text-dark'>
                            {xgBoostData.equation ? <> Equation:  {xgBoostData.equation}</> : <></>}
                        </div>
                    </div>
                    <div className='row d-flex flex-row'>
