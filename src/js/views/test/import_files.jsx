...
const ImportFiles = (props) => {
    ...
    return (<>
        <div id="ingestedList" className={styles.modal}>
            ...
            <form className="row d-flex py-2 mx-2 px-1 align-items-center" onSubmit={(e) => handleSubmitFiles(e)} enctype="multipart/form-data" style={{ width: "100%" }}>
                ...
                <div className='col-sm-12 col-lg-6 d-flex justify-content-start align-items-center'>
                    <input className={`${styles.nav_button} ${styles.import_button}`} type="file" title="upload file" name="file" onChange={handleFileFormat} multiple id="upload-files" />
                </div>
                <div className='col-sm-12 col-lg-6 d-flex justify-content-start align-items-center'>
                    <button className={`${styles.nav_button} ${styles.import_button}`}/*  onClick={handleSubmitCSV} */ type='submit'>
                        <>
                            Upload File(s)
                        </>
                    </button>
            ...
            <div className='row d-flex py-2 mx-2 px-1 align-items-center' style={{ width: "100%" }}>
                ...
                <div className='col-sm-12 col-lg-6 d-flex justify-content-start align-items-center'>
                    <button className={`${styles.nav_button} ${styles.import_button}`} type='button' onClick={getTranscription}>Ingest Youtube Video</button>
                </div>
            </div>
            ...
            <div className='card' style={{ overflowY: "scroll", width: "100%", maxHeight: "300px" }}>
                {deletePage ?
                    <ul>
            ...
            <button type="button" className={`${styles.nav_button} ${styles.import_button}`} onClick={e => { props.setModalImport(!props.modalImport) }}>Close</button>
        </div>
    </>
